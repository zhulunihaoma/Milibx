...
@interface CompmanaViewController ()

@end

@implementation CompmanaViewController
...
//    底部按钮
    ...
    [AddBtn setTitle:@"新增机构" forState:UIControlStateNormal];
...
#pragma mark -- 按钮方法
-(void)AddCom{
    AddNewComViewController *avc = [[AddNewComViewController alloc]init];
