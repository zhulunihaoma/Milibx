...
- (void)refreshScrollView
{
    ...
    [self.buttonsArray[0] setTitle:[currentDisplayNews[0] componentsSeparatedByString:@","][0] forState:UIControlStateNormal];
    [self.buttonsArray[1] setTitle:[currentDisplayNews[1] componentsSeparatedByString:@","][0] forState:UIControlStateNormal];
    [self.buttonsArray[2] setTitle:[currentDisplayNews[2] componentsSeparatedByString:@","][0] forState:UIControlStateNormal];
